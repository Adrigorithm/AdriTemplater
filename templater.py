...
class TemplaterConfig:
    ...
    language_file_delimiter: str | None = None
    template_char_left: str | None = None
    template_char_right: str | None = None

    def __init__(
        self,
        patterns: list[str] | None,
        language_file_delimiter: str | None,
        template_char_left: str | None,
        template_char_right: str | None,
    ) -> None:
...
def get_file_paths(root_dir: str, patterns: list[str]) -> set[str]:
...
def main(
    ...
    files_to_template = get_file_paths(input_dir, config.patterns)  # pyright: ignore[reportArgumentType] config.patterns is always a string here.
    language_map = content_language_mapper(
        language_file,
        config.language_file_delimiter,  # pyright: ignore[reportArgumentType] config.language_file_delimiter is always a string here.
    )
    ...
    for file_path in files_to_template:
        templated_strings = template(
            file_path,
            language_map,
            config.template_char_left,  # pyright: ignore[reportArgumentType] config.template_char_left is always a string here.
            config.template_char_right,  # pyright: ignore[reportArgumentType] config.template_char_right is always a string here.
        )
